...
const LocationPicker = ({ pickedLocation, onLocationPick }: LocationPickerProps) => (
  <div>
    ...
    <div className="h-48 rounded-lg overflow-hidden border">
      <MapCanvas photos={[]} pickingLocation onLocationPick={onLocationPick} pickedLocation={pickedLocation} />
    </div>
  </div>
);
